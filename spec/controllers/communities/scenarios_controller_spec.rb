...
RSpec.describe Communities::ScenariosController, :type => :controller do
  ...
  describe "GET index" do
    it "assigns all scenarios as @scenarios" do
      scenario = FactoryGirl.create_list(:scenario, 10, community: community, access: ACCESS_LEVEL[:PUBLIC])
  ...
  describe "GET show" do
    it "assigns the requested scenario as @scenario" do
      scenario = FactoryGirl.create(:scenario, :public)
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new Scenario" do
        expect {
          post :create, {community_id: community.id, :scenario => FactoryGirl.attributes_for(:scenario, :public)}
      ...
      it "redirects to the created scenario" do
        post :create, {community_id: community.id, :scenario => FactoryGirl.attributes_for(:scenario, :public, community: community)}
        expect(response).to redirect_to([community, Scenario.last])
      end
    end

    describe "with invalid params" do
      let (:invalid_attributes){ FactoryGirl.attributes_for(:scenario, :public, name: nil) }
  ...
  describe "PUT update" do
    describe "with valid params" do
      let(:new_attributes) {
        FactoryGirl.attributes_for(:scenario, :public, name: "変更")
      }

      it "updates the requested scenario" do
        scenario = FactoryGirl.create(:scenario, :public, community: community)
